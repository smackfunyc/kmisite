// ── Latest Quotes before change to vercel form ─────────────────────────────────────────────────────────────────
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-white pt-4">
              ...
              {/* Example pills */}
              <div className="mt-8">
                <p className="text-white/40 text-[15px] uppercase tracking-widest mb-3">Try an example</p>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                  {examples.map(ex => (
                    <button key={ex} className="tariff-pill-btn" onClick={() => setQuery(ex)}>{ex}</button>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div ref={formRef}>
              ...
              <div style={{
                ...
                border: '1px solid rgba(232,185,81,0.25)',
                borderRadius: 18,
